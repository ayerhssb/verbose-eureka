...
const AboutSection: React.FC = () => {
  ...
  useEffect(() => {
    aboutSection ? onSectionChange!("about me") : onSectionChange!("");
    ...
    >
      <section id="about-me" className="section">
        <RoughNotationGroup>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-y-12 lg:gap-x-8 items-center">
            <div className="lg:col-span-2 flex justify-center items-center py-4 lg:mb-[20%]">
            ...
            <div className="lg:col-span-3 flex flex-col justify-center gap-y-8 lg:ml-8">
              <div className="about-intro space-y-4">
                <p>
                  My journey started in college with a curiosity for problem-solving (and a lot of late-night debugging). Since then, I've worked on various projects, automation tools, and full-stack platforms and somewhere along the way, I realized I genuinely enjoy building things that make life easier.
                  Right now, I'm focused on becoming a really solid software engineer, learning how great systems are designed, and contributing to meaningful products (and some open-source too).
                </p>
                <p>
              ...
              <div ref={eduRef}>
                <p className="edu-bg my-4 font-medium text-marrsgreen dark:text-carrigreen">Here is my educational background.</p>
...
const educationInfo = [
  {
    id: 1,
    title: "Integrated Dual Degree in Chemical Engineering",
    subTitle: "Indian Institute of Technology Kharagpur | 2022 ~ 2026",
    list: [
  ...
  },
  {
    ...
    subTitle: "DAV Public School Bariatu | 2019 - 2021",
    list: [
      "Grade: 96.4%",
    ],
  },
  {
    id: 3,
    title: "AISSE (CBSE Class X)",
    subTitle: "DAV Public School Bariatu | 2019",
    list: ["Grade: 98.2%"],
  },
];
