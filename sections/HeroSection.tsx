...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        PASSIONATE PROGRAMMER FULL-STACK DEVELOPER CREATIVE
      </span>
      ...
      <div className="image-animation z-10 select-none mt-0 xs:mt-6 sm:mt-14 lg:mt-0 px-0 mx-auto lg:p-0 lg:basis-1/3">
        {/* <div className="relative w-72 md:w-80 h-80 flex items-center mx-auto">
          <div className="absolute pointer-events-none scale-100 mx-auto">
            <Image
              src="/shreya-photo-bg-removebg-preview.png"
              width={1177}
              height={1374}
              priority
              id="character-illustration"
              aria-label="Shreya's photo"
              alt="Shreya's photo"
            />
          </div>
        </div> */}
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            ...
            exceptional results.
            I'm a Full Stack Developer who loves building products that look good, work fast, and don't break in production.
          </p>
          <p>
